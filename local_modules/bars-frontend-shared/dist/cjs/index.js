...
const BootstrapDialog = styles$b.styled(material.Dialog)(({ theme }) => ({
...
function BarsDialog(props) {
    return (jsxRuntime.jsxs(BootstrapDialog, { onClose: props.onClose, "aria-labelledby": "customized-dialog-title", open: props.isVisible, maxWidth: 'sm', children: [jsxRuntime.jsxs("div", { className: styles$a.DialogTitle, children: [props.dialogTitle, jsxRuntime.jsx("div", { className: styles$a.DialogCloseContainer, onClick: props.onClose, children: jsxRuntime.jsx(iconsMaterial.Close, { className: styles$a.DialogCloseBtn }) })] }), jsxRuntime.jsx("div", { className: styles$a.DialogContent, children: props.children }), jsxRuntime.jsxs("div", { className: styles$a.DialogButtons, children: [props.multiButtons ? props.multiButtons
                        .map((item, index) => (jsxRuntime.jsx(BarsButton, { text: item?.buttonText, onClick: item?.onButtonClick, variant: item?.variant }, index)))
                        : (props?.buttonText ? jsxRuntime.jsx(BarsButton, { text: props?.buttonText ?? '', onClick: props?.onButtonClick, variant: props?.redButton == true ? 'red' : (props?.buttonVariant ?? 'green') }) : null), jsxRuntime.jsx(BarsButton, { text: '\u041E\u0442\u043C\u0435\u043D\u0430', onClick: props.onClose, variant: 'white', style: { borderColor: 'var(--bars-gray-mid2)', color: 'var(--bars-gray-mid2)' } })] })] }));
}

function BarsAccordion({ Header, children, Expanded, OnExpand }) {
    const CustomAccordion = material.styled((props) => (jsxRuntime.jsx(material.Accordion, { disableGutters: true, elevation: 0, square: true, ...props })))(({ theme }) => ({
    ...
    const CustomAccordionSummary = material.styled((props) => (jsxRuntime.jsx(material.AccordionSummary, { expandIcon: jsxRuntime.jsx(iconsMaterial.ArrowForwardIosSharp, { sx: { fontSize: '0.9rem' } }), ...props })))(({ theme }) => ({
    ...
    return (jsxRuntime.jsxs(CustomAccordion, { expanded: expand, children: [jsxRuntime.jsx(CustomAccordionSummary, { onClick: OnExpand, expandIcon: jsxRuntime.jsx(iconsMaterial.ExpandMore, {}), "aria-controls": "panel1a-content", id: "panel1a-header", children: Header }), children] }));
}
...
function BarsAccordionItem({ children }) {
    return (jsxRuntime.jsx(material.AccordionDetails, { className: styles$9.container, children: children }));
}
...
function Container({ HeaderElement, HeaderText, Buttons, children, headerStyle, className, style }) {
    return (jsxRuntime.jsxs("div", { style: style, className: className ? className + ' ' + styles$8.container : styles$8.container, children: [jsxRuntime.jsxs("div", { className: styles$8.containerHeader, style: headerStyle, children: [HeaderElement ? HeaderElement : (HeaderText ?? ''), jsxRuntime.jsx("div", { className: styles$8.itemIcons, children: Buttons ? Buttons.map((button, index) => (jsxRuntime.jsx("div", { onClick: button.OnClick, className: styles$8.Icon, style: { backgroundImage: `url(/${button.IconName})` } }, index)))
                            : null })] }), children] }));
}
...
function SimpleList({ items, BottomItem, ClassName, style }) {
    const [hoveredElementIndex, setHoveredElementIndex] = React__namespace.useState(-1);
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", { className: ClassName, style: style, children: items ? items.map((value, index) => {
                    var element = value.Href ?
                        (jsxRuntime.jsxs(reactRouterDom.Link, { className: (value.IsChecked ? (styles$6.item + ' ' + styles$6.activeItem) : styles$6.item) + ' ' + value.ClassName, to: value.Href, style: value.Style, onClick: () => {
                                if (value.OnClick)
                                    value.OnClick();
                            }, onMouseEnter: () => setHoveredElementIndex(index), onMouseLeave: () => setHoveredElementIndex(-1), children: [value.Label, jsxRuntime.jsx("div", { className: styles$6.itemIcons, children: value.Buttons ? value.Buttons?.map((button, buttonIndex) => {
                                        return (jsxRuntime.jsx("div", { onClick: button.OnClick, className: styles$6.Icon, style: { backgroundImage: hoveredElementIndex == index ?
                                                    `url(/${button.IconName})` : 'unset' } }, buttonIndex));
                                    }) : null })] }, index)) :
                        (jsxRuntime.jsxs("div", { className: (value.IsChecked ? (styles$6.item + ' ' + styles$6.activeItem) : styles$6.item) + ' ' + value.ClassName, style: value.Style, onClick: () => {
                                if (value.OnClick)
                                    value.OnClick();
                            }, onMouseEnter: () => setHoveredElementIndex(index), onMouseLeave: () => setHoveredElementIndex(-1), children: [value.Label, jsxRuntime.jsx("div", { className: styles$6.itemIcons, children: value.Buttons ? value.Buttons?.map((button, buttonIndex) => {
                                        return (jsxRuntime.jsx("div", { onClick: button.OnClick, className: styles$6.Icon, style: { backgroundImage: hoveredElementIndex == index ?
                ...
                jsxRuntime.jsx("div", { className: styles$6.bottomItem, children: jsxRuntime.jsx(BottomItem, {}) }) : null] }));
}

function ContaineredList({ ListHeader, HeaderButtons, items, BottomItem, className, style }) {
    return (jsxRuntime.jsxs(Container, { className: className, style: style, HeaderText: ListHeader, Buttons: HeaderButtons, children: [jsxRuntime.jsx(SimpleList, { ClassName: styles$7.ListInContainer, items: items, BottomItem: BottomItem }), BottomItem ?
                jsxRuntime.jsx("div", { className: styles$7.bottomItem, children: jsxRuntime.jsx(BottomItem, {}) }) : null] }));
}
...
function Navigation({ onClickBack, items, styleRootNav, styleSpanLink }) {
    const breadcrumbs = items?.map((item, index) => {
        return (jsxRuntime.jsx("span", { style: styleSpanLink, onClick: item.OnClick, className: styles$5.NavItem + ' ' + (item.IsActive == true ? styles$5.ActiveNavItem : ''), children: item.element == undefined ? item.Label : item.element }, index));
    });
    return (jsxRuntime.jsxs("nav", { style: styleRootNav, className: styles$5.navRoot, children: [jsxRuntime.jsxs("span", { style: { display: onClickBack ? "flex" : "none" }, onClick: onClickBack, className: styles$5.ButtonBack, children: [jsxRuntime.jsx("svg", { width: "7", height: "10", viewBox: "0 0 7 10", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: jsxRuntime.jsx("path", { d: "M5.96544 8.74118C6.01017 8.78412 6.04514 8.83463 6.06835 8.88982C6.09156 8.94502 6.10256 \n            9.00382 6.10072 9.06287C6.09888 9.12192 6.08423 9.18007 6.05762 9.23398C6.03101 9.2879 5.99295 9.33654\n            5.94561 9.37711C5.89828 9.41768 5.8426 9.4494 5.78176 9.47046C5.72091 9.49151 5.65609 9.50149 5.59099\n            9.49982C5.52589 9.49815 5.4618 9.48486 5.40236 9.46072C5.34292 9.43658 5.28931 9.40206 5.24458\n            9.35912L1.03046 5.3115C0.943433 5.22799 0.894941 5.11744 0.894941 5.00253C0.894941 4.88762 0.943433\n            4.77706 1.03046 4.69356L5.24458 0.645485C5.28901 0.601608 5.34262 0.566177 5.40227 0.541251C5.46193\n            0.516325 5.52645 0.502399 5.59209 0.500284C5.65772 0.498169 5.72317 0.507906 5.78463 0.528929C5.84608\n            0.549952 5.90232 0.581841 5.95007 0.622747C5.99783 0.663653 6.03615 0.712758 6.0628 0.767211C6.08946\n            0.821664 6.10392 0.880379 6.10535 0.939944C6.10678 0.999511 6.09515 1.05874 6.07113 1.11419C6.04711\n            1.16965 6.01119 1.22022 5.96544 1.26297L2.07259 5.00253L5.96544 8.74118Z", fill: "#C4C4C4" }) }), jsxRuntime.jsx("a", { style: { marginLeft: "15px" }, children: "\u041D\u0430\u0437\u0430\u0434" })] }), jsxRuntime.jsx(material.Breadcrumbs, { sx: styleSpanLink, separator: "\u203A", "aria-label": "breadcrumb", className: styles$5.NavContainer, children: breadcrumbs })] }));
}
...
function BarsInput({ defaultValue, placeholder, maxHeight, maxWidth, icon, backgroundColor, onChange, type, className, style, iconSrc, iconPosition, onIconClick }) {
    ...
    return (jsxRuntime.jsxs("div", { className: `${styles$4.barsInputContainer} ${className}`, style: {
            flexDirection: iconPosition == 'start' ? 'row-reverse' : 'row',
            backgroundColor: backgroundColor,
            maxHeight: maxHeight,
            maxWidth: maxWidth
        }, children: [jsxRuntime.jsx("input", { className: `${styles$4.barsInput} ${className}`, style: style, value: value ?? '', placeholder: placeholder, type: inputType, onChange: (event) => {
                    setValue(event.target.value);
                    if (onChange)
                        onChange(event.target.value);
                } }), icon ?? (iconSrc ? jsxRuntime.jsx("img", { className: styles$4.barsInputImage, src: iconSrc, onClick: onIconClick }) : null)] }));
}
...
function BarsTabs({ tabs, style, className }) {
    ...
    return (jsxRuntime.jsxs("div", { className: className ? (className + ' ' + styles$3.mainContainer) : styles$3.mainContainer, style: style, children: [jsxRuntime.jsx(material.Tabs, { className: styles$3.tabs, value: value, onChange: handleChange, textColor: "primary", indicatorColor: "primary", children: tabs.map((tab, index) => {
                    return (jsxRuntime.jsx(material.Tab, { className: styles$3.tab, label: tab.label, ...getProps(index) }, index));
                }) }), jsxRuntime.jsx("div", { className: styles$3.tabsContent, children: tabs[value]?.children ?? null })] }));
}
...
function BarsDrawer({ children, drawerPosition, widthSizePercents, visible, onClose, headerText, buttonText, onClickButton, minWidthPx, style, loading, onClickButtonCancel }) {
    return (jsxRuntime.jsx(material.Drawer, { anchor: drawerPosition ?? "right", open: visible, onClose: onClose, style: style, children: jsxRuntime.jsxs("div", { style: {
                width: widthSizePercents ? `${widthSizePercents}vw` : 'unset',
                maxWidth: `90vw`,
                minWidth: minWidthPx ? `min(90vw, ${minWidthPx}px)` : 'unset'
            }, className: styles$2.drawerMainContainer, children: [jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx("p", { className: styles$2.drawerHeaderText, children: headerText }), children] }), jsxRuntime.jsxs("div", { className: styles$2.drawerButtonsContainer, children: [buttonText ? jsxRuntime.jsx(BarsButton, { variant: 'green', text: buttonText, onClick: onClickButton, loading: loading, onClickCancel: onClickButtonCancel }) : null, jsxRuntime.jsx(BarsButton, { variant: 'white', text: '\u0417\u0430\u043A\u0440\u044B\u0442\u044C', onClick: onClose })] })] }) }));
}
...
function BarsMenu({ anchorElement, setAnchorElement, items, style, children }) {
    ...
    const BarsMenu = styles$b.styled((props) => (jsxRuntime.jsx(material.Menu, { style: style, elevation: 0, anchorOrigin: {
            vertical: 'bottom',
            horizontal: 'right',
        }, transformOrigin: {
            vertical: 'top',
    ...
    return (jsxRuntime.jsxs(BarsMenu, { anchorEl: anchorElement, open: Boolean(anchorElement), onClose: handleClose, children: [items?.map((item, index) => (jsxRuntime.jsx(material.MenuItem, { style: item.style, onClick: (e) => {
                    if (item.onClick)
                        item.onClick(e);
...
function BarsSwitch({ checked, OnClick, OnSemiEnabledClick, label }) {
    const AntSwitch = styles$b.styled(material.Switch)(({ theme }) => ({
        minWidth: "45px",
        maxWidth: "45px",
        minHeight: "24px",
        maxHeight: "24px",
    ...
    return (jsxRuntime.jsxs("div", { style: { display: 'flex', flexDirection: 'row', alignItems: 'center' }, children: [checked == "semi-enabled" ?
                jsxRuntime.jsx("img", { src: '/swith-semi-enabled.svg', onClick: OnSemiEnabledClick }) :
                jsxRuntime.jsx(AntSwitch, { checked: checked, onClick: OnClick }), label ? jsxRuntime.jsx("div", { style: { paddingLeft: '10px' }, children: label }) : null] }));
}
...
function BarsButton({ className, text, variant, disabled, onClick, icon, iconPosition, style, loading, onClickCancel }) {
    const iconLoading = jsxRuntime.jsx(material.CircularProgress, { size: 20, color: "inherit", sx: { margin: "0 5px 4px 0" } });
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(material.Button, { id: styles$1.barsButton, style: { alignItems: "center" }, sx: style, className: className + ' ' + (variant == 'red' ? styles$1.redButton :
                    ...
                    iconPosition == 'start' && loading ? iconLoading : undefined, endIcon: iconPosition != 'start' && icon != undefined ? icon : loading ? iconLoading : undefined, disableElevation: true, children: text }), loading && jsxRuntime.jsx(material.Tooltip, { title: "\u041E\u0442\u043C\u0435\u043D\u0438\u0442\u044C", placement: "top", children: jsxRuntime.jsx(material.IconButton, { onClick: onClickCancel, children: jsxRuntime.jsx(iconsMaterial.Cancel, { color: "error", sx: { padding: "0px" } }) }) })] }));
}
...
function BarsTextField({ className, id, error = false, label, helperText, style, value, onChange, onChangeWithAdvance, inputRef, placeholder, onKeyDown, inputProps, onFocus, onBlur, disabled, type, multiline, advanceEdit, emojiSupport }) {
    ...
    const [emojiBarVisible, setEmojiBarVisible] = React.useState(false);
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [advanceEdit ?
                jsxRuntime.jsxs("div", { className: styles.styleButtonsContainer, children: [jsxRuntime.jsx("div", { title: "\u0416\u0438\u0440\u043D\u044B\u0439", style: { fontWeight: '600' }, className: styles.styleButton, onClick: () => insertTagToString('b'), children: "\u0416" }), jsxRuntime.jsx("div", { title: "\u041A\u0443\u0440\u0441\u0438\u0432", style: { fontStyle: 'italic' }, className: styles.styleButton, onClick: () => insertTagToString('i'), children: "\u041A" }), jsxRuntime.jsx("div", { title: "\u041F\u043E\u0434\u0447\u0451\u0440\u043A\u043D\u0443\u0442\u044B\u0439", style: { textDecoration: 'underline' }, className: styles.styleButton, onClick: () => insertTagToString('u'), children: "\u041F" }), jsxRuntime.jsx("div", { title: "\u0417\u0430\u0447\u0451\u0440\u043A\u043D\u0443\u0442\u044B\u0439", style: { textDecoration: 'line-through' }, className: styles.styleButton, onClick: () => insertTagToString('del'), children: "\u0417" }), jsxRuntime.jsx("div", { title: "\u041E\u0442\u0441\u0442\u0443\u043F (\u043A\u0440\u0430\u0441\u043D\u0430\u044F \u0441\u0442\u0440\u043E\u043A\u0430)", className: styles.styleButton, onClick: () => insertText('&#182'), children: "Tab" }), jsxRuntime.jsx("div", { title: "\u0421\u0441\u044B\u043B\u043A\u0430", className: styles.styleButton, onClick: () => insertTagToString('a', true), children: "\uD83D\uDD17" }), jsxRuntime.jsx("div", { title: "\u041C\u0430\u0440\u043A\u0438\u0440\u043E\u0432\u0430\u043D\u044B\u0439 \u0441\u043F\u0438\u0441\u043E\u043A", className: styles.styleButton, onClick: () => insertListMarkers(), children: "\u22EE\u2263" }), jsxRuntime.jsx("div", { title: "\u041F\u0435\u0440\u0435\u0447\u0438\u0441\u043B\u044F\u0435\u043C\u044B\u0439 \u0441\u043F\u0438\u0441\u043E\u043A", className: styles.styleButton, onClick: () => insertListEnumerable(), children: "1\u2263" })] })
                : undefined, jsxRuntime.jsxs("div", { className: styles.textFieldWrapper, children: [jsxRuntime.jsx(BarsTextFieldStyled, { sx: multiline ? { "div": { height: 'unset' }, ...style } : style, value: valueState, itemType: "", disabled: disabled, onChange: ((e) => {
                            if (onChange)
                                onChange(e);
                            setValueState(e.currentTarget.value);
                        }), onFocus: onFocus, onBlur: onBlur, onKeyDown: onKeyDown, className: `${styles.barsInput}${className ? ` ${className}` : ''}`, id: id, label: label, error: error, placeholder: placeholder, type: type ?? 'text', variant: "outlined", helperText: error ? helperText : undefined, inputRef: inputRef ?? inputRefInternal, InputProps: inputProps, multiline: multiline }), jsxRuntime.jsxs("div", { className: styles.smileIconWrapper, children: [emojiSupport ?
                                jsxRuntime.jsx(SmileIconSvg, { className: emojiBarVisible ? `${styles.smileIcon} ${styles.brightness}` : styles.smileIcon, onClick: () => {
                                        if (emojiBarVisible)
                                            setEmojiBarVisible(false);
                                        else
                                ...
                                jsxRuntime.jsxs("div", { className: styles.smileBar, style: {
                                        position: "absolute",
                                        left: -230, // 250 - ширина smileBar
                                        top: 18,
                                        width: 250,
                                    }, children: [jsxRuntime.jsx("p", { className: styles.smileHint, onClick: () => setEmojiBarVisible(false), children: "\u0412\u0438\u0434 \u044D\u043C\u043E\u0434\u0437\u0438 \u0432 \u043F\u0440\u0438\u043B\u043E\u0436\u0435\u043D\u0438\u0438 \u043C\u043E\u0436\u0435\u0442 \u043E\u0442\u043B\u0438\u0447\u0430\u0442\u044C\u0441\u044F" }), emojis.map(set => jsxRuntime.jsx("p", { className: styles.smileRow, children: set.map(em => jsxRuntime.jsx("span", { className: styles.smile, onClick: () => InsertEmoji(em), children: em })) }))] })
                                : undefined] })] })] }));
}
...
function BarsTable({ columns, data, onRowSelectionChange, rowSelection, enableRowSelection, bodyAlign, headAlign, topCustomElements, bottomCustomElementsByRowSelection, style, noRecordsLabel, isLoading, showProgressBars, columnSeparator = false, enableDensityToggle, enableEditing, enableStickyHeader = true, enableColumnPinning, enableExpanding, getSubRows, columnVisibility, onColumnVisibilityChange, elementBottomToolbarCenter, elementBottomToolbarRigth, enablePagination = true, bottomCustomElements, maxHeight = '100%' }) {
    ...
    const MRT_Localization_RU_Custom = ru.MRT_Localization_RU;
    ...
    const table = materialReactTable.useMaterialReactTable({
        ...
        renderEmptyRowsFallback: noRecordsLabel ? () => (jsxRuntime.jsx("span", { style: {
                textAlign: "center",
                marginTop: "40px"
    ...
    const globalTheme = material.createTheme({
        palette: {
            common: {
                black: '#000'
            },
    ...
    const tableTheme = React.useMemo(() => material.createTheme({
        palette: {
    ...
    return (jsxRuntime.jsx(react.ThemeProvider, { theme: tableTheme, children: jsxRuntime.jsx(materialReactTable.MaterialReactTable, { table: table }) }));
}
...
const BarsSelectStyled = styles$b.styled(material.Select)({
    background: "#ffffff",
    fontSize: "14px",
    fontFamily: `"Rubik", "sans-serif"`,
    fontWeight: 400,
